...
(edad >= EDAD_MINIMA && edad <= EDAD_MAXIMA) ? console.log(`La edad ingresada (${edad}) es válida.`) : console.log(`La edad ingresada (${edad}) no es válida. Debe estar entre ${EDAD_MINIMA} y ${EDAD_MAXIMA} años.`);''